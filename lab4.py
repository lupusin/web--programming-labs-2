...
users = [
    {'login': 'egor', 'password': '12333', 'name': 'Егор ЛАпшин ', 'gender': 'male'},
    {'login': 'Horosho', 'password': 'pop45631', 'name': 'Крутой Мужик 228', 'gender': 'female'}
]
...
def fridge():
    ...
    if request.method == 'POST':
        ...
        if temperature < -12:
            message = "Не удалось установить заданную вами температуру — слишком низкое значение"
        elif temperature > -1:
            message = "Не удалось установить  заданную вами  температуру — слишком высокое значение"
